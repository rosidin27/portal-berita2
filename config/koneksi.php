<?php
@session_start();
$GLOBALS['BASE_URL'] = "http://".$_SERVER['SERVER_NAME']."/portal-berita2";
...
//================================================================================
//KONEKSI MySQLi
	@$GLOBALS['mysqli'] = mysqli_connect("localhost","root","","berita2");
	if(!mysqli_connect("localhost","root","","berita2")){
		echo "<script>alert('Terjadi Kesalahan Pada Koneksi DataBase !');</script>"; 
		exit();
	}
//================================================================================
